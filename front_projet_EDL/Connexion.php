...
<body class=" d-flex flex-column min-vh-100">
    ...
    <main class="d-flex justify-content-center align-items-center  flex-fill">
        <section class="container w-50 shadow p-5 my-5">
            ...
            <h6 class="text-center text-secondary mb-3"> Connectez-vous à votre compte pour accéder à la page d'accueil
            </h6>
            <form method="post" action="">
                ...
                if (isset($_SESSION["succes"])) {
                    ...
                    echo '<div class="alert alert-success d-flex" role="alert"> ' . htmlspecialchars($_SESSION["succes"]) . '</div>';
                ...
                <?php if (isset($error["user_name"])) {
                    echo "is-invalid";
                        ...
                        value="<?php echo isset($error) ? htmlspecialchars($nom_utilisateur) : "" ?>">
                    <p> <small class="text-danger"> <?php if (isset($error["user_name"])) {
                        echo htmlspecialchars($error['user_name']);
                ...
                <div class="p-2 form-group form-password-toggle ">
                    ...
                    <?php if (isset($error["password"])) {
                        echo "is-invalid";
                            ...
                            value="<?php echo isset($error) ? htmlspecialchars($mot_de_passe) : "" ?>">
                        <span class="input-group-text cursor-pointer"><i class="bi bi-eye" id="eyeToggle1"></i></span>
                    </div>
                    <p> <small class="text-danger"> <?php if (isset($error["password"])) {
                        echo htmlspecialchars($error["password"]);
