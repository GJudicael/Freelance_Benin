      ...
      <!-- Carte 1 -->
        <div class="col-lg-8 col-md-12">
            <div class="card h-100 p-2 shadow border-primary-subtle border-3 rounded-4">
                <div class="card-body">
                    <div class="user-info pb-3"><i class="bi bi-person-fill"></i> Posté par : <a href="info_profile.php" class="text-decoration-none text-tertiary"> <strong> <?php echo htmlspecialchars($demande["nom"]) ; echo ' '. htmlspecialchars($demande["prenom"]) ?></strong> </a></div>
